        ...
        <div class="card">
            <div class="card-header">
                <ul class="nav nav-pills">
                    <li class="nav-item">
                        <a class="nav-link text-success" href="index.php"><i class="bi bi-house-door-fill"></i>
                            Inicio</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active bg-success" href="Pagos.php"><i class="bi bi-credit-card-fill"></i>
                            Pagar</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="card-body">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <?php if ($cart->total_items() > 0) { ?>
                                <td class="text-center"><strong>Total <?php echo '$' . $cart->total() . ' MX'; ?></strong>
                                </td>
                            <?php } ?>
                        </tr>
                    </tfoot>
                ...
                <div class="shipAddr">
                    ...
                    <form action="">
                    <input type="radio" name="pago" id="efectivo" value="1">
                    <label for="efectivo" class="fw-bold text-success"><i class="bi bi-wallet2"></i> Pago en efectivo</label><br>
                    <input type="radio" name="pago" id="tarjeta" value="2">
                    <label for="tarjeta" class="fw-bold text-success"><i class="bi bi-credit-card-2-front"></i> Tarjeta de debito o credito</label>
                    </form>
                </div>
                <div class="footBtn">
